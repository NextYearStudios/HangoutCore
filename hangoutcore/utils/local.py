...
class appConfig(object):
    ...
    async def get(config: str = "hangoutcore.properties"):
        ...
        def failLocate():
            log.ERROR(
                f"Attempted to locate properties file '{config}'. Nothing was found."
            )
            return None
    ...
    EXAMPLE_CONFIG = {  # Changing this will only matter when the bot creates a new Config(). Actual config at CONFIG_PATH
        "bot": {
            ...
            "messages": {
                ...
                "error_bot_fail": [
                    101,
                    "Uh oh, Appears my code failed somewhere.\nPlease try again later, If this error persists please submit a ticket via our support server.",
                ],
                "error_bot_invaliddatabaseconfiguration": [
                    102,
                    "Failed to access database.\nPlease try again later, If this error persists please submit a ticket via our support server.",
                ],
                "error_bot_invalidguilddata": [
                    103,
                    "Failed to retreive data for this guild.\nPlease try again later, If this error persists please submit a ticket via our support server.",
                ],
                "error_bot_invaliduserdata": [
                    104,
                    "Failed to retreive data for this user.\nPlease try again later, If this error persists please submit a ticket via our support server.",
                ],
                "error_user_blacklisted": [
                    201,
                    "You're currently blacklisted from using this bot.\nreason: `{blacklist_reason}`",
                ],
                "error_user_blacklisted_noreason": [
                    201,
                    "You're currently blacklisted from using this bot.\nreason: `No Reason could be found, Please submit a ticket via our support server.`",
                ],
                "error_user_insufficientpermissions": [
                    202,
                    "You do not have the necessary permissions to use that. This event has been logged and a staff member has been notified.",
                ],
                "error_user_invalidguildbalance": [
                    203,
                    "Failed to retreive user balance.\nPlease try again later, If this error persists please submit a ticket via our support server.",
                ],
                "error_user_insufficientguildbalance": [
                    204,
                    "Sorry, You have insufficient funds to perform this action.",
                ],
                "error_command_arg_uniquemember": [
                    301,
                    "Sorry, You have to select someone other than yourself.",
                ],
                "error_command_arg_botmember": [
                    302,
                    "Sorry, You have to select an actual member. Bot members are not allowed.",
                ],
                "error_command_arg_positive": [
                    303,
                    "Sorry, You must provide a positive number greater than 0.",
                ],
                "error_system_notenabled": [
                    401,
                    "Sorry, {system_name} is not enabled here.",
                ],
            },
            "emoji": {"nsfw": "<:nsfw:1056285352723230751>"},
        },
        "database": {
            "type": "mysql",
            "host": "localhost",
